...
<List>
    ...
    leftAvatar = { <Avatar
        ...
        />}>
    <p> My love
    for UpKeep knows no bounds! </p> 
    </ListItem> 
    <ListItem disabled = { true }
    leftAvatar = { <Avatar src = { chen }
        size = { 50 }
        style = { style }/>}>
    ...
    </ListItem> <ListItem disabled = { true }
    leftAvatar = { <Avatar
        src = { matt }
        size = { 50 }
        style = { style }
    ...
    <p> UpKeep not only cleaned my house but left me mints! </p> </ListItem> </List>
);
